...
\begin{enumerate}
  ...
  \item Tím je zónový soubor pro doménu {\tt fit.cz} připravený. Nyní vytvořte zónový soubor pro reverzní překlad:
    ...
    \begin{itemize}
      ...
      \item V~nově vytvořeném souboru {\tt /var/named/db.10.10.10.rev} upravte hodnotu TTL na {\tt 3h}.
  ...
  \item Dočasně upravte nastavení firewallu, aby propouštěl DNS dotazy a odpovědi. To provedete příkazem {\tt firewall-cmd --add-service=dns}
