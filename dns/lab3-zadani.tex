...
\title{NTP, SSH, DNS, DNSSEC\\
{\bf\large ISA - Postup laboratorního cvičení č.3}}

\author{Libor Pol\v{c}\'{a}k\footnote{Vysoké učení technické v Brně,
    {\tt\{ipolcak\}@fit.vutbr.cz}}}
    \date{2016, verze 1.2}
\begin{document}
...
\newpage
  \item {\bf Omezení použití klíčů}
    ...
    \begin{enumerate}
      ...
      \item Přihlaste na počítač, kam jste nakopírovali své veřejné klíče a
...
\begin{enumerate}
  ...
  \item Pracujte ve dvojicích. Jeden z dvojice buden konfigurovat server (PC A)
