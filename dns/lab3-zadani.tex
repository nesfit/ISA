...
\begin{enumerate}
    ...
    \item Ve webovém prohlížeči zadejte do adresního řádku adresu \url{www.facebook.com}. Podařilo se Vám stránku zobrazit? Pokud ano, restartujte počítač, aby se vymazala mezipaměť DNS.
