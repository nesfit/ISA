...
\begin{center}
{\LARGE Síťové aplikace a správa sítí\\[1em]
\huge\bf Cvičení 3 - Laboratorní manuál}\\[2em]

Libor Polčák, Martin Holkovič\symbolfootnote[1]{FIT VUT v~Brně,
{\tt \{ipolcak,iholkovic\}@fit.vutbr.cz}} s využitím textů Patrika Halfara\\[1ex]

{\large zimní semestr 2016/2017, verze 1.2}
