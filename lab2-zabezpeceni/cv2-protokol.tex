...
\hline
~ & Název souboru & Přístupová práva \\
\hline
Veřejný klíč: & & \\
\hline
Privátní klíč: & & \\
...
\textbf{2.8 c)} Jak proběhlo opakované přihlášený na vzdálený počítač pomocí SSH? \\
...
\textbf{3.3 b)} Použitá šifrovací sada v prohlížeči (id, name): \\
