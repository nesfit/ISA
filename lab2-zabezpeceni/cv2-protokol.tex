...
%M:\underline{\hspace{1cm}}\hspace{1cm} S:\underline{\hspace{1cm}}\hspace{1cm}NTP server: \underline{\hspace{4cm}}\hspace{1cm} stratum: \underline{\hspace{1cm}} \\
%M:\underline{\hspace{1cm}}\hspace{1cm} S:\underline{\hspace{1cm}}\hspace{1cm}NTP server: \underline{\hspace{4cm}}\hspace{1cm} stratum: \underline{\hspace{1cm}} \\
%M:\underline{\hspace{1cm}}\hspace{1cm} S:\underline{\hspace{1cm}}\hspace{1cm}NTP server: \underline{\hspace{4cm}}\hspace{1cm} stratum: \underline{\hspace{1cm}} \\
%M:\underline{\hspace{1cm}}\hspace{1cm} S:\underline{\hspace{1cm}}\hspace{1cm}NTP server: \underline{\hspace{4cm}}\hspace{1cm} stratum: \underline{\hspace{1cm}} \\
%Význam příznaku M: \\
...
\hline
M & S & \hspace{3cm}Server\hspace{3cm} & Stratum \\ \hline
...
\textbf{2.4 e)} Uveďte, jaké zajímavé informace lze vyčíst z odchycené komunikace SSH:
...
\textbf{2.7 d)} Vypište výstup na terminálu při přihlášení z účtu {\tt root}:\\
...
{\bf 3.2 f)-g)} Vyplňte informace o použité šifrovací sadě (cipher suite):\\
