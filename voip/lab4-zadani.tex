...
\end{figure}
    ...
    {\it (V~případě neúspěchu účet odeberte, ukončete Jitsi a postupujte znovu od kroku 1), případně konzultujte problém se cvičícím.)}
	...
	\item Buď na PC-A nebo na PC-B vyfiltrujte \emph{SIP} komunikaci ze zachyceného provozu, analyzujte registraci a doplňte do protokolu požadované údaje z~paketu zaslaného ústředně (PC-U), který obsahuje žádost o~registraci klienta Jitsi nainstalovaného na PC-A nebo PC-B.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Na PC-A (jako uživatel \emph{test01}) zadejte v~aplikaci Jitsi do pole pro telefonní číslo SIP adresu uživatele \emph{test02}: \linebreak{\bf 1002@10.0.2.15}, kde místo {\bf 10.0.2.15} napište IP adresu počítače PC-U (ústředny). 1002 je telefonní klapka uživatele \emph{test02}.
