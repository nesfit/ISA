...
\item Zobrazte si záznamy v~routovací a ARP tabulce. Zapište IP4v4 adresu výchozí brány a přiřaďte k ní MAC adresu.
...
\item Upravte patřičný soubor tak, aby po spuštění příkazu \texttt{ping gateway}, byl ping proveden vůči IPv4 adrese 10.10.10.1. Zapište jak a který soubor jste upravili a jaký záznam jste přidali.
