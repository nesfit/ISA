...
rozhraní pro jejich manipulaci. Pro Linux distribuce se \texttt{systemd} máme
...
dhclient -v [rozhraní]
\end{verbatim}
Argument \texttt{-v} zajistí, že aplikace vypíše detailní informace. V případě,
že vypisuje chybu pro {\tt smbd.service}, můžete ji ignorovat.
...
Na naších počítačích je nainstalovaná systémová služba {\tt radvd.service},
