...
\section{Vzdálený termínál - Secure Shell (SSH)}
\textbf{2.} Co můžeme ze zachycené komunikace vyčíst?\\

\underline{\hspace{10cm}}
~\\~\\
Jsou v této komunikaci vidět zadávané příkazy a jejich výstup? \underline{\hspace{1cm}}\\
~\\
\textbf{3.} Vyplňte požadované informace o veřejném a privátním klíči:
~\\
\begin{tabular}{|r|c|c|c|}
\hline
~ & Význam & Název souboru & Oprávnění souboru \\
\hline
